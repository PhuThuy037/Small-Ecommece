...
import ecommerce.smallecomerce.dto.*;
import ecommerce.smallecomerce.entity.*;
...
public class EntityDtoMapper {
    ...
    public UserDto mapUserToDtoPlusAddressAndOrderHistory(User user) {
        ...
        if (user.getOrderItems() != null && !user.getOrderItems().isEmpty()) {
            userDto.setOrderItemList(user.getOrderItems()
                    .stream()
